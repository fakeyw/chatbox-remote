...
import { PocketBaseStorage } from './storages/pocketbase_storage'
import type { Platform, PlatformType } from './interfaces'
import type { KnowledgeBaseController } from './knowledge-base/interface'
import WebExporter from './web_exporter'
import { parseTextFileLocally } from './web_platform_utils'

export default class PocketBaseWebPlatform extends PocketBaseStorage implements Platform {
  public type: PlatformType = 'web'
  
  public exporter = new WebExporter()

  constructor(pocketBaseAddr: string) {
    super(pocketBaseAddr)
  }

  public async getVersion(): Promise<string> {
    return 'web-pocketbase'
  }
